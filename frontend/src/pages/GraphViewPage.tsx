    ...
    <aside style={{ width: '320px', flexShrink: 0, background: 'rgba(2,6,23,0.6)', border: '1px solid rgba(255,255,255,0.12)', borderRadius: 12, padding: 16 }}>
      ...
      {selectedData.type === 'document' && (
          ...
          <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap', marginBottom: 16 }}>
            <span style={{ padding: '4px 10px', borderRadius: 999, fontSize: 12, background: colors[selectedData.data.importance as keyof typeof colors], color: 'white' }}>
...
export default function GraphViewPage() {
  ...
  return (
    <div style={{ padding: 24, display: 'flex', gap: 16, height: 'calc(100vh - 48px)' }}>
      <div style={{
